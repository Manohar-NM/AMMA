  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-4 top-4 z-50 h-12 w-12 rounded-full border border-white/15 bg-white/10 text-sm shadow-glow backdrop-blur-xl transition hover:border-aureate/60 hover:bg-white/15"
